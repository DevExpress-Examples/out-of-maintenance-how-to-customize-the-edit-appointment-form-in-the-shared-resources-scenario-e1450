...
<table style="width:100%; height:100%">
    <tr>
        <td rowspan="2"  style="vertical-align:top;">
            <dxe:ASPxImage id="Image" runat="server" EnableViewState="False" ImageUrl='<%#Page.ClientScript.GetWebResourceUrl(typeof(ASPxScheduler), "Images.StatusInfo.Warning.png") %>' Width="48px" Height="48px" IsPng="true">
            </dxe:ASPxImage>
        </td>
        <td style="width:100%;">
